...
namespace Bugsweeper
{
    public partial class ExtPopup : Form
    {
        ...
        private void pBtnDefault_Click(object sender, EventArgs e)
        {

        }

        private void pRetryBtn_Click(object sender, EventArgs e)
        {

        }

        private void pExtBtn_Click(object sender, EventArgs e)
        {
